...
[![Publish Docker image](https://github.com/autonomousEnterprises/chatgpt-telegram-bot/actions/workflows/publish.yaml/badge.svg)](https://github.com/autonomousEnterprises/chatgpt-telegram-bot/actions/workflows/publish.yaml)
...
### Plugins
![plugins](https://github.com/autonomousEnterprises/chatgpt-telegram-bot/assets/11541888/83d5e0cd-e09a-463d-a292-722f919e929f)
...
If you'd like to help, check out the [issues](https://github.com/autonomousEnterprises/chatgpt-telegram-bot/issues) section and contribute!  
If you want to help with translations, check out the [Translations Manual](https://github.com/autonomousEnterprises/chatgpt-telegram-bot/discussions/219)
...
Check out the [Budget Manual](https://github.com/autonomousEnterprises/chatgpt-telegram-bot/discussions/184) for possible budget configurations.
...
| `BOT_LANGUAGE`                      | Language of general bot messages. Currently available: `en`, `de`, `ru`, `tr`, `it`, `fi`, `es`, `id`, `nl`, `zh-cn`, `zh-tw`, `vi`, `fa`, `pt-br`, `uk`, `ms`, `uz`, `ar`.  [Contribute with additional translations](https://github.com/autonomousEnterprises/chatgpt-telegram-bot/discussions/219) | `en`                               |
...
```shell
git clone https://github.com/autonomousEnterprises/chatgpt-telegram-bot.git
...
or using the [GitHub Container Registry](https://github.com/autonomousEnterprises/chatgpt-telegram-bot/pkgs/container/chatgpt-telegram-bot/):
